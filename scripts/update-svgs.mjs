...
// Read both stats files
const statsAll = JSON.parse(readFileSync(resolve(rootDir, 'assets/stats.json'), 'utf-8'));
const statsPublic = JSON.parse(readFileSync(resolve(rootDir, 'assets/stats-public.json'), 'utf-8'));

// Generate all 4 SVGs
writeFileSync(resolve(rootDir, 'assets/stats.svg'), generateStatsSvg(statsAll));
console.log('Updated assets/stats.svg');

writeFileSync(resolve(rootDir, 'assets/stats-public.svg'), generateStatsSvg(statsPublic));
console.log('Updated assets/stats-public.svg');

writeFileSync(resolve(rootDir, 'assets/top-langs.svg'), generateTopLangsSvg(statsAll));
console.log('Updated assets/top-langs.svg');

writeFileSync(resolve(rootDir, 'assets/top-langs-public.svg'), generateTopLangsSvg(statsPublic));
console.log('Updated assets/top-langs-public.svg');
